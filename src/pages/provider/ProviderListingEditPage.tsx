// Edit listing page for providers
...
const MOCK_EXISTING_DATA: FormData = {
  title: 'Marine Engine Repair Service',
  category: 'Repair Services',
  description: 'Professional marine engine repair and maintenance services. We specialize in both inboard and outboard engines, providing comprehensive diagnostics, repairs, and preventive maintenance.',
  priceType: 'Per Hour',
  price: '$150',
...
export function ProviderListingEditPage() {
  ...
  const [formData, setFormData] = useState<FormData>(MOCK_EXISTING_DATA);
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Update your pricing structure for this service
            </CardDescription>
          </CardHeader>
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
...
export default ProviderListingEditPage;